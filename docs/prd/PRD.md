...
## HECHOS APROBADOS
- LegacyPay es una pasarela B2B.  <!-- ##HECHO -->
- Un comercio autorizado consulta transacciones de los últimos 90 días. <!-- DECISIÓN APROBADA: El historial permitirá consultar únicamente transacciones de los últimos 90 días. -->
- Filtros mínimos requeridos: fecha, estado y monto.  <!-- ##HECHO -->
...
<!-- #PROPUESTA DE IA :Actualmente los comercios necesitan una interfaz/endpoint.. Nunca se dijo que hoy no exista. -->
...
- 
<!-- #PREGUNTA ABIERTA :¿Cuál será el tamaño de página por defecto y el máximo permitido para la paginación? -->
--- 
